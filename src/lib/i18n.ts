...
const en: Dict = {
  ...
  "goals.manualTopUp": "Manual top-up (optional)",
  "goals.taggedHint": "Progress updates automatically from income tagged to this goal.",
  "goals.tagToGoal": "Add to a goal",
  "goals.noGoal": "No goal",
  ...
  "admin.masterSwitch": "Ads master switch",
  "admin.adsEnabled": "Ads enabled",
  "admin.toggleAdsEnabled": "Toggle ads enabled",
  "admin.masterSwitchHint":
    "Instantly hides ads app-wide, regardless of any account's promo status or grace period.",
  "admin.gracePeriodLabel": "Grace period (days before a new account sees any ad)",
  "admin.placementsTitle": "Ad placements",
  "admin.placementsHint":
    "Each placement is one ad spot in the app, wired to whichever network you choose — different placements can run different networks side by side.",
  "admin.placementKeyPlaceholder": "Placement key (e.g. dashboard)",
  "admin.clientIdPlaceholder": "Client ID (e.g. ca-pub-... or Media.net cid)",
  "admin.slotIdPlaceholder": "Slot / ad unit ID",
  "admin.adding": "Adding…",
  "admin.addNewPlacement": "Add new placement",
  "admin.noPlacements": "No ad placements yet.",
  "admin.enabled": "Enabled",
  "admin.disabled": "Disabled",
  "admin.slotLabel": "{network} · slot {slot}",
  "admin.promoCodesTitle": "Promo codes",
  "admin.codePlaceholder": "Code (e.g. FRIENDSFAM)",
  "admin.labelOptional": "Label (optional)",
  "admin.maxRedemptionsPlaceholder": "Max redemptions (blank = unlimited)",
  "admin.creating": "Creating…",
  "admin.createCode": "Create code",
  "admin.noCodes": "No codes yet.",
  "admin.alreadyRedeemedWarning":
    "Already redeemed {n} times — setting a lower max just blocks further redemptions, it won't revoke existing ones.",
  "admin.redeemedOf": "{count} / {max} redeemed",
  "admin.unlimited": "unlimited",
  "admin.active": "Active",
  "admin.inactive": "Inactive",
  "admin.redemptionsTitle": "Redemptions",
  "admin.redemptionsHint":
    "Everyone who's currently ad-free via a promo code. Revoking removes it immediately — ads resume for that account.",
  "admin.noRedemptions": "No redemptions yet.",
  "admin.codeDate": "code {code} · {date}",
  "admin.revoke": "Revoke",
  "admin.createCodeFailed": "Couldn't create that code — it may already exist.",
  "admin.saveEditFailed": "Couldn't save — that code may already exist.",
  "admin.deleteCodeConfirm": "Delete promo code \"{code}\"?",
  "admin.deleteCodeBlocked":
    "Can't delete \"{code}\" — someone has redeemed it. Revoke their access first.",
...
const zh: Dict = {
  ...
  "goals.manualTopUp": "手动追加金额（可选）",
  "goals.taggedHint": "进度会根据标记到此目标的收入自动更新。",
  "goals.tagToGoal": "计入目标",
  "goals.noGoal": "不计入目标",
  ...
  "admin.notAuthorized": "未获授权。",
  "admin.backOffice": "后台管理",
  "admin.masterSwitch": "广告总开关",
  "admin.adsEnabled": "启用广告",
  "admin.toggleAdsEnabled": "切换广告开关",
  "admin.masterSwitchHint": "立即在全应用范围内隐藏广告，无论账户的优惠码状态或宽限期如何。",
  "admin.gracePeriodLabel": "宽限期（新账户多少天后才会看到广告）",
  "admin.placementsTitle": "广告位",
  "admin.placementsHint": "每个广告位对应应用中的一个广告位置，可绑定您选择的任意网络 — 不同广告位可同时运行不同网络。",
  "admin.placementKeyPlaceholder": "广告位标识（如 dashboard）",
  "admin.clientIdPlaceholder": "客户 ID（如 ca-pub-... 或 Media.net cid）",
  "admin.slotIdPlaceholder": "广告单元 ID",
  "admin.adding": "添加中…",
  "admin.addNewPlacement": "添加新广告位",
  "admin.noPlacements": "暂无广告位。",
  "admin.enabled": "已启用",
  "admin.disabled": "已禁用",
  "admin.slotLabel": "{network} · 广告位 {slot}",
  "admin.promoCodesTitle": "优惠码",
  "admin.codePlaceholder": "优惠码（如 FRIENDSFAM）",
  "admin.labelOptional": "标签（可选）",
  "admin.maxRedemptionsPlaceholder": "最大兑换次数（留空 = 不限）",
  "admin.creating": "创建中…",
  "admin.createCode": "创建优惠码",
  "admin.noCodes": "暂无优惠码。",
  "admin.alreadyRedeemedWarning": "已被兑换 {n} 次 — 设置更低的上限只会阻止后续兑换，不会撤销已有的兑换。",
  "admin.redeemedOf": "已兑换 {count} / {max}",
  "admin.unlimited": "不限",
  "admin.active": "启用中",
  "admin.inactive": "已停用",
  "admin.redemptionsTitle": "兑换记录",
  "admin.redemptionsHint": "所有目前通过优惠码获得无广告权益的用户。撤销后立即生效 — 该账户将恢复显示广告。",
  "admin.noRedemptions": "暂无兑换记录。",
  "admin.codeDate": "优惠码 {code} · {date}",
  "admin.revoke": "撤销",
  "admin.createCodeFailed": "创建失败 — 该优惠码可能已存在。",
  "admin.saveEditFailed": "保存失败 — 该优惠码可能已存在。",
  "admin.deleteCodeConfirm": "删除优惠码「{code}」？",
  "admin.deleteCodeBlocked": "无法删除「{code}」— 已有用户兑换。请先撤销其权益。",
...
const ms: Dict = {
  ...
  "goals.manualTopUp": "Tambahan manual (pilihan)",
  "goals.taggedHint": "Kemajuan dikemas kini secara automatik daripada pendapatan yang ditanda ke matlamat ini.",
  "goals.tagToGoal": "Tambah ke matlamat",
  "goals.noGoal": "Tiada matlamat",
  "goals.emojiLabel": "Emoji",
  ...
  "admin.notAuthorized": "Tidak dibenarkan.",
  "admin.backOffice": "Pejabat belakang",
  "admin.masterSwitch": "Suis induk iklan",
  "admin.adsEnabled": "Iklan diaktifkan",
  "admin.toggleAdsEnabled": "Togol iklan diaktifkan",
  "admin.masterSwitchHint":
    "Segera menyembunyikan iklan di seluruh aplikasi, tanpa mengira status promo atau tempoh tangguh mana-mana akaun.",
  "admin.gracePeriodLabel": "Tempoh tangguh (hari sebelum akaun baharu melihat sebarang iklan)",
  "admin.placementsTitle": "Penempatan iklan",
  "admin.placementsHint":
    "Setiap penempatan ialah satu ruang iklan dalam aplikasi, disambungkan kepada rangkaian pilihan anda — penempatan berbeza boleh menjalankan rangkaian berbeza serentak.",
  "admin.placementKeyPlaceholder": "Kunci penempatan (cth. dashboard)",
  "admin.clientIdPlaceholder": "ID Klien (cth. ca-pub-... atau cid Media.net)",
  "admin.slotIdPlaceholder": "ID slot / unit iklan",
  "admin.adding": "Menambah…",
  "admin.addNewPlacement": "Tambah penempatan baharu",
  "admin.noPlacements": "Belum ada penempatan iklan.",
  "admin.enabled": "Diaktifkan",
  "admin.disabled": "Dinyahaktifkan",
  "admin.slotLabel": "{network} · slot {slot}",
  "admin.promoCodesTitle": "Kod promosi",
  "admin.codePlaceholder": "Kod (cth. FRIENDSFAM)",
  "admin.labelOptional": "Label (pilihan)",
  "admin.maxRedemptionsPlaceholder": "Had tebusan (kosong = tanpa had)",
  "admin.creating": "Mencipta…",
  "admin.createCode": "Cipta kod",
  "admin.noCodes": "Belum ada kod.",
  "admin.alreadyRedeemedWarning":
    "Telah ditebus {n} kali — menetapkan had lebih rendah hanya menyekat tebusan seterusnya, tidak membatalkan yang sedia ada.",
  "admin.redeemedOf": "{count} / {max} ditebus",
  "admin.unlimited": "tanpa had",
  "admin.active": "Aktif",
  "admin.inactive": "Tidak aktif",
  "admin.redemptionsTitle": "Tebusan",
  "admin.redemptionsHint":
    "Semua yang kini bebas iklan melalui kod promosi. Membatalkan mengalih keluar serta-merta — iklan disambung semula untuk akaun itu.",
  "admin.noRedemptions": "Belum ada tebusan.",
  "admin.codeDate": "kod {code} · {date}",
  "admin.revoke": "Batalkan",
  "admin.createCodeFailed": "Gagal cipta kod itu — mungkin sudah wujud.",
  "admin.saveEditFailed": "Gagal simpan — kod itu mungkin sudah wujud.",
  "admin.deleteCodeConfirm": "Padam kod promosi \"{code}\"?",
  "admin.deleteCodeBlocked":
    "Tidak boleh padam \"{code}\" — seseorang telah menebusnya. Batalkan akses mereka dahulu.",
