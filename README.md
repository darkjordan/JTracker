...
Stack: Next.js 15 · React · TypeScript · Tailwind · Supabase · Vercel. Reuses the
patterns from its sibling project **JKira**.

Status: **Phase 0 — spec'd, not yet scaffolded.** Next up: Phase 1 (money core + manual entry).
